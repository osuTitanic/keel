...
BITVIEW_API_ENDPOINT = os.environ.get('BITVIEW_API_ENDPOINT')
BITVIEW_USERNAME = os.environ.get('BITVIEW_USERNAME')
BITVIEW_CLOUDFLARE_SOLVER = os.environ.get('BITVIEW_CLOUDFLARE_SOLVER')
BITVIEW_ENABLED = BITVIEW_API_ENDPOINT and BITVIEW_USERNAME
